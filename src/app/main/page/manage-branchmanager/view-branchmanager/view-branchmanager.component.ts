...
@Component({
  ...
  templateUrl: './view-branchmanager.component.html',
  styleUrls: ['./view-branchmanager.component.scss']
})
  ...
  ngOnInit(): void {
    ...
    this.apiService.viewBranchManager(this.id).subscribe((response) => {
      ...
      if (response['status'] == "OK") {
        this.branchmanage_code=response['data'].profile_code;
